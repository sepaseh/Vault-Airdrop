			...
			<div className="w-full max-w-4xl mt-8">
				<div className="text-start mb-8">
					...
					<button
						...
						className="text-white bg-[#061B3A]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-20 py-2.5 text-left inline-flex items-center  dark:focus:ring-blue-800"
						type="button"
					>
						Main Vault
						<svg
				...
				<div className="space-y-4">
					...
					<div className="bg-[#061B3A] p-4 rounded-lg flex items-center justify-between flex-wrap">
						...
						<div className="flex items-center space-x-4">
							...
							/>
							<Image
								src="/images/icon-caret-left.png"
								width={22}
								height={22}
								alt="cube"
							/>
					...
					<div className="text-left">
						<button className="rounded-full flex items-center">
							...
							<Image
								src="/images/icon-plus-circle.png"
								width={40}
								height={40}
								alt="PlusCircle"
							/>
